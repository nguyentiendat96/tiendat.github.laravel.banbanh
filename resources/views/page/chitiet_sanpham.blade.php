	...
	<div id="content">
		<div class="row">
			<div class="col-sm-9">
				...
				<div class="row">
					<div class="col-sm-4">
						<img src="source/image/product/{{$sanpham->image}}" height="250px" width="250px" alt="">
					</div>
					<div class="col-sm-8">
						<div class="single-item-body">
							<p class="single-item-title"><h2>{{$sanpham->name}}</h2></p>
							<p class="single-item-price" style="font-size: 20px;margin-top: 10px;">
			...
			<div class="col-sm-3 aside">
				...
				<div class="widget">
					...
					<div class="widget-body">
						...
						<div class="beta-sales beta-lists">
							<div class="media beta-sales-item" style="position: relative;
							left: 2px;
							top: 16px;
