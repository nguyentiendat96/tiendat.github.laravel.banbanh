...
Class UserController extends Controller
{
    public function ajaxSua(Request $request){
        $id = $request->input('id');
        $users = User::find($id);
        $users->full_name= $request->input('fullname');
    ...
    public function ajaxXoa(Request $request){
        $id = $request->input('id');
        $users = User::find($id);
    ...
    public function postDangnhapAdmin(Request $request)
    {
        $this->validate($request,
            ...
            'password.min'=>'Đăng nhập không thành công',
            'password.max'=>'Đăng nhập không thành công',
            ]);
